<%-- 
    Document   : ajoutDossier
    Created on : 4 avr. 2021, 16 h 47 min 15 s
    Author     : booska
--%>
...
<html>
    ...
    <body>
        ...
        <div class="soustitre2" >
            <h1>Ajout de Dossier</h1>
        </div>
        <p class='erreur'>${message}</p>
        <f:form class="form" method="post" modelAttribute="formDossier" id="addForm">
                <div class="row">
                    ...
                    <div class="form-group col-sm-3 col-sm-offset-8">
                        <input type="submit" class="form-control btn btn-primary active" value=" Ajouter " />
                    </div>
                </div>
            </f:form>
        </div>
